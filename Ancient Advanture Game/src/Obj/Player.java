...
//		AudioPlayer.load("/SFX/playerlands.mp3", "playerlands");
//		AudioPlayer.load("/SFX/playerattack.mp3", "playerattack");
//		AudioPlayer.load("/SFX/playerhit.mp3", "playerhit");
//		AudioPlayer.load("/SFX/playercharge.mp3", "playercharge");
