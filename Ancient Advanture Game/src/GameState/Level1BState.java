...
import Obj.EnemyProjectile;
import Obj.Enemy;
import Obj.EnergyParticle;
import Obj.Explosion;
import Obj.HUD;
import Obj.Player;
import Obj.PlayerSave;
import Obj.Teleport;
import Obj.Title;
import Obj.Enemies.Gazer;
import Obj.Enemies.GelPop;
import Obj.Enemies.Tengu;
...
public class Level1BState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/Background/graveback.gif", 0.5, 0);
		
		// tilemap
		tileMap = new TileMap(30);
		tileMap.loadTiles("/Tilesets/aa.gif");
		tileMap.loadMap("/Maps/grave.map");
...
//		AudioPlayer.load("/SFX/teleport.mp3", "teleport");
//		AudioPlayer.load("/SFX/explode.mp3", "explode");
//		AudioPlayer.load("/SFX/enemyhit.mp3", "enemyhit");
//		
	}
	...
	private void populateEnemies() {
		...
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1280, 250);
		enemies.add(gp);
		
		gp = new GelPop(tileMap, player);
		gp.setPosition(1600, 160);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1640, 160);
		enemies.add(gp);
		
		gp = new GelPop(tileMap, player);
		gp.setPosition(2600, 200);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2620, 150);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2640, 150);
		enemies.add(gp);
		
		gp = new GelPop(tileMap, player);
		gp.setPosition(2020, 150);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2050, 150);
		enemies.add(gp);
		
		g = new Gazer(tileMap);
		g.setPosition(800, 50);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(900, 100);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(950, 170);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(1320, 200);
		enemies.add(g);
		
		g = new Gazer(tileMap);
		g.setPosition(1625, 140);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(1800, 170);
		enemies.add(g);
		
		g = new Gazer(tileMap);
		g.setPosition(2075, 150);
		enemies.add(g);

		g = new Gazer(tileMap);
		g.setPosition(2700, 200);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(2720, 60);
		enemies.add(g);
		
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2040, 200);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2175, 50);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2100, 50);
		enemies.add(t);

		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2600, 100);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2400, 150);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2657, 200);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2588, 200);
		enemies.add(t);
