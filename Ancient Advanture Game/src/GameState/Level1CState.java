...
import Obj.Portal;
import Obj.Spirit;
import Obj.Artfact.BottomLeftPiece;
import Obj.Artfact.BottomRightPiece;
import Obj.Artfact.TopLeftPiece;
import Obj.Artfact.TopRightPiece;
import Obj.Enemies.DarkEnergy;
...
public class Level1CState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/Background/temple.gif", 0.5, 0);
...
//		
		// music
//		AudioPlayer.load("/Music/level1boss.mp3", "level1boss");
//		AudioPlayer.load("/Music/fanfare.mp3", "fanfare");
...
//				0,
//				60000,
//				AudioPlayer.getFrames("level1boss") - 4000
//			);
		}
		if(eventCount == 420) {
