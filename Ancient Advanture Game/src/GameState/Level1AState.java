...
public class Level1AState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		mountains = new Background("/Background/desertback.gif", 0.2);
		sky = new Background("/Background/sky.gif", 0);
		clouds = new Background("/Background/clouds.gif", 0.1);
...
//		AudioPlayer.loop("level1", 600, AudioPlayer.getFrames("level1") - 2200);
